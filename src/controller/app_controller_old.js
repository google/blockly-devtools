...
/**
 * @fileoverview The AppController1 Class brings together the Block
 * Factory, Block Library, and Block Exporter functionality into a single web
 * app.
 *
 * @author quachtina96 (Tina Quach)
 */
goog.provide('AppController1');
 ...
 * @constructor
 */
AppController1 = function() {
  this.name = 'AppController1';
  ...
  this.tabMap[AppController1.BLOCK_FACTORY] =
      document.getElementById('blockFactory_tab');
  this.tabMap[AppController1.WORKSPACE_FACTORY] =
      document.getElementById('workspaceFactory_tab');
  this.tabMap[AppController1.EXPORTER] =
      document.getElementById('blocklibraryExporter_tab');

  // Last selected tab.
  this.lastSelectedTab = null;
  // Selected tab.
  this.selectedTab = AppController1.BLOCK_FACTORY;
...
AppController1.BLOCK_FACTORY = 'BLOCK_FACTORY';
AppController1.WORKSPACE_FACTORY = 'WORKSPACE_FACTORY';
AppController1.EXPORTER = 'EXPORTER';
 ...
 */
AppController1.prototype.importBlockLibraryFromFile = function() {
 ...
 */
AppController1.prototype.exportBlockLibraryToFile = function() {
 ...
 * @private
 */
AppController1.prototype.formatBlockLibraryForExport_ = function(blockXmlMap) {
  // Create DOM for XML.
 ...
 * @private
 */
AppController1.prototype.formatBlockLibraryForImport_ = function(xmlText) {
 ...
 * @private
 */
AppController1.prototype.getBlockTypeFromXml_ = function(xmlText) {
  var xmlDom = Blockly.Xml.textToDom(xmlText);
 ...
 */
AppController1.prototype.addTabHandlers = function(tabMap) {
  var self = this;
 ...
 * @param {string} tabName AppController1.BLOCK_FACTORY,
 *    AppController1.WORKSPACE_FACTORY, or AppController1.EXPORTER
 * @return {!Function} The tab click handler.
 * @private
 */
AppController1.prototype.makeTabClickHandler_ = function(tabName) {
  return () => {
 ...
 * @private
 */
AppController1.prototype.styleTabs_ = function() {
 ...
 */
AppController1.prototype.assignExporterClickHandlers = function() {
  var self = this;
 ...
 */
AppController1.prototype.assignExporterChangeListeners = function() {
  var self = this;
 ...
 */
AppController1.prototype.assignLibraryClickHandlers = function() {
 ...
 */
AppController1.prototype.assignBlockFactoryClickHandlers = function() {
 ...
 */
AppController1.prototype.addBlockFactoryEventListeners = function() {
 ...
 */
AppController1.prototype.onresize = function(event) {
  if (this.selectedTab == AppController1.BLOCK_FACTORY) {
  ...
  } else if (this.selectedTab == AppController1.EXPORTER) {
 ...
 */
AppController1.prototype.confirmLeavePage = function(e) {
 ...
 */
AppController1.prototype.openModal = function(id) {
  Blockly.hideChaff();
  this.modalName_ = id;
 ...
 */
AppController1.prototype.closeModal = function() {
 ...
 * @private
 */
AppController1.prototype.modalName_ = null;

/**
 * Initialize Blockly and layout.  Called on page load.
 */
AppController1.prototype.init = function() {
 ...
 */
AppController1.prototype.createBlocklyInitPopup = function(firstLoad) {
  this.newBlockDialogController.showNewBlockDialog(firstLoad);
};

AppController1.prototype.newProject = function() {
